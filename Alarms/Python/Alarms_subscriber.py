...
class Alarms_IntrusionAlarmSubscriber:
    ...
    def run_subscriber(domain_id: int, sample_count: int):
        ...
        # This DataReader reads data on Topic "Example Alarms_IntrusionAlarm".
        ...
        def condition_handler(_):
            ...
            nonlocal reader
            samples_read += Alarms_IntrusionAlarmSubscriber.process_data(reader)
