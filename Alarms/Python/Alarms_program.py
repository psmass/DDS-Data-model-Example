...
import argparse
import sys
from Alarms_publisher import Alarms_IntrusionAlarmPublisher
from Alarms_subscriber import Alarms_IntrusionAlarmSubscriber
...
def main():
    ...
    if(args.pub):
        print(f"Running Alarms_IntrusionAlarmPublisher on domain {args.domain}")
        Alarms_IntrusionAlarmPublisher.run_publisher(
            domain_id=args.domain,
            sample_count=args.sample_count)
    else:
        print(f"Running Alarms_IntrusionAlarmSubscriber on domain {args.domain}")
        Alarms_IntrusionAlarmSubscriber.run_subscriber(
            domain_id=args.domain,
            sample_count=args.sample_count)
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Runs Alarms_IntrusionAlarmPublisher or Alarms_IntrusionAlarmSubscriber')
