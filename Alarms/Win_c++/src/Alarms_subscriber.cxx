...
unsigned int process_data(Alarms_IntrusionAlarmDataReader *typed_reader)
{
    Alarms_IntrusionAlarmSeq data_seq;     // Sequence of received data
    ...
    for (int i = 0; i < data_seq.length(); ++i) {
        ...
        if (info_seq[i].valid_data) {
            ...
            Alarms_IntrusionAlarmTypeSupport::print_data(&data_seq[i]);
            samples_read++;
...
int run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    // This DataReader reads data on "Example Alarms_IntrusionAlarm" Topic
    ...
    Alarms_IntrusionAlarmDataReader *typed_reader =
    Alarms_IntrusionAlarmDataReader::narrow(untyped_reader);
