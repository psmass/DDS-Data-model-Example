...
unsigned int process_data(Sensor::GasSensorDataReader *typed_reader)
{
    Sensor::GasSensorSeq data_seq;     // Sequence of received data
    ...
    for (int i = 0; i < data_seq.length(); ++i) {
        ...
        if (info_seq[i].valid_data) {
            ...
            Sensor::GasSensorTypeSupport::print_data(&data_seq[i]);
            samples_read++;
...
int run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    // This DataReader reads data on "Example Sensor_GasSensor" Topic
    ...
    Sensor::GasSensorDataReader *typed_reader =
    Sensor::GasSensorDataReader::narrow(untyped_reader);
